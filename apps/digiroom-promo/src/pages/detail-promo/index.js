...
import { MdOutlineArrowBack, MdShare } from 'react-icons/md';
        ...
        <div className="flex mt-0 md:mt-16 gap-4 px-4 md:px-16">
          <div className="flex flex-col">
            ...
            <Image
              ...
              height={1}
            />
            <div className="flex mt-6 md:mt-16 justify-between items-center">
            ...
            <h1 className="text-black mt-6 md:mt-16 font-semibold">Periode Promosi</h1>
            ...
            <h4 className="text-xl mt-6 md:mt-16 mb-2 font-semibold text-black">Detail Promosi</h4>
