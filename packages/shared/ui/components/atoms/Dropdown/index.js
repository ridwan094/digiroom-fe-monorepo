...
const Dropdown = ({ label, options, onSelect, selectedOption, placeholder, size = "w-full" }) => {
  ...
  return (
    <div className={`relative ${size}`}>
      ...
      <div className="flex items-center">
        ...
        {/* Handle toggle icon */}
        {selectedOption ? (
          <span className="absolute right-3 text-red-500 cursor-pointer" onClick={deleteSelectedOption}>
            &#x2716;
          </span>
        ) : (
          <span
