        ...
        <Fragment>
          ...
          <div className="flex items-center">
            <input
              ...
              className="w-full outline-none px-4 py-2 bg-[#f8f8f8] border-b-2 border-reliableBlack30 text-black cursor-pointer focus:border-b-2 lg:bg-[#FFFEFE] lg:border-b lg:border-[#5F5F5F]"
